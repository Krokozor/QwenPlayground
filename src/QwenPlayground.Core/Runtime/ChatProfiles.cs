    ...
    public void EnsureDefaults()
    {
        ...
        Prompts.TryAdd(SubagentPromptKey, new PromptProfile {
            SystemPrompt =
                ...
                "- полки browser / csharp / desktop / mcp / intuition — активируй activate_shelf, если задача требует " +
                "(браузер, анализ C#, работа с экраном, внешние приложения, логит-пробы своей модели);\n" +
